...
//            throw new RuntimeException("zip error from ZipUtils", e);
    ...
    private static void closeOutput(ZipOutputStream zos, FileOutputStream fos) {
        if (zos != null) {
            try {
                zos.close();
            } catch (IOException e) {
    ...
    private static void zipOutWrite(ZipOutputStream zos, File srcFile, String name) throws IOException {
...
//        /** 测试压缩方法1  */
//        FileOutputStream fos1 = new FileOutputStream(new File("E:\\yy.zip"));
//        ZipUtils.toZip("E:\\yyy\\ice-master\\.gitignore", fos1, true);
//        /** 测试压缩方法2  */
